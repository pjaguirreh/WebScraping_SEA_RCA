...
# Juntar todos los ids de cada elemento de la lista en un data frame 
todo <- bind_rows(listtotal)

setwd('//Higuera\DGI/Proyectos/Inteligencia de negocios/Programa de fiscalización/Datos')

#openxlsx::write.xlsx(tabreg, "RCA_Region_VIII.xlsx")
